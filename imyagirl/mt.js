...
(function () {
  ...
  function _initializeVariables() {
    ...
    loadingIcon = "<img title='Loading...' src='https://connexus.sys5.co/mt-static/images/indicator.white.gif' alt='Loading' />";
  ...
  function _updateComments() {
    ...
    cacheKey = [direction, entryID, commentsPerPage, offset]
        ...
        .replace(/[^a-zA-Z0-9-]/g, '');
    jsonUrl  = [
        "https://connexus.sys5.co/mt-comments.cgi?__mode=comment_listing&direction=",
        direction,
        "&entry_id=",
        entryID,
        "&limit=",
...
function mtFetchUser(cb) {
    ...
    if ( ( cb == 'mtSetUser' ) && mtGetUser() ) {
        ...
        script.src = 'https://connexus.sys5.co/mt-comments.cgi?__mode=userinfo&blog_id=2&jsonp=' + cb + '&ts=' + ts + '&sid=' + u.sid;
        (document.getElementsByTagName('head'))[0].appendChild(script);
    }
}
...
function mtVerifySession(cb) {
    ...
    var ts = new Date().getTime();
    var u = mtGetUser();
    script.src = 'https://connexus.sys5.co/mt-comments.cgi?__mode=verify_session&blog_id=2&jsonp=' + cb + '&ts=' + ts + '&sid=' + u.sid;
    (document.getElementsByTagName('head'))[0].appendChild(script);
}
...
function mtCommentOnSubmit(f) {
    if (!mtRequestSubmitted) {
        ...
        if (f.armor)
            f.armor.value = 'ad0a3b14001c4be34e6d25e3a6e0c8a98e24b69a';
...
function mtSignIn() {
    ...
    if (is_preview) {
        if ( document['comments_form'] ) {
            ...
            url += '&return_url=https%3A%2F%2Fconnexus-preview.sys5.co%2Fimyagirl%2F';
        }
    } else {
